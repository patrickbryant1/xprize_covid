...
ADDITIONAL_CONTEXT_FILE = "./Additional_Context_Data_Global.csv"
ADDITIONAL_US_STATES_CONTEXT = "./US_states_populations.csv"
ADDITIONAL_UK_CONTEXT = "./uk_populations.csv"
ADDITIONAL_BRAZIL_CONTEXT = "./brazil_populations.csv"
