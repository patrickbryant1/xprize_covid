...
def load_model():
    ...
    modeldir='/home/patrick/results/COVID19/xprize/simple_rf/comparing_median/all_regions/3_weeks/non_log/US/all'
    for i in range(5):
        try:
            models.append(pickle.load(open(modeldir+'/model'+str(i), 'rb')))
        except:
...
def predict(start_date, end_date, path_to_ips_file, output_file_path):
    ...
    data_path = '/home/patrick/results/COVID19/xprize/simple_rf/comparing_median/all_regions/3_weeks/non_log/US/US_adjusted_data.csv'
    ...
    for g in ips_df.GeoID.unique():
        ...
        while current_date <= end_date:
            ...
            X = np.append(X,[death_to_case_scale,case_death_delay,gross_net_income,population_density,
                            ...
                            cancer, smoking_deaths, pneumonia_dr, air_pollution_deaths,
                            co2_emission, air_transport,
